...
ida <- function(df, seeds) {
  ...
  lowerBounds <- c(Ka = 1000,
    c(I0 = 0, IHD = 10^6, ID = 0), # 470
    c(I0 = 0, IHD = 10^6, ID = 0), # 486
    c(I0 = 0, IHD = 10^6, ID = 0), # 512
    c(I0 = 0, IHD = 10^6, ID = 0), # 524
    c(I0 = 0, IHD = 10^6, ID = 0), # 532
    c(I0 = 0, IHD = 10^6, ID = 0)  # 550
  )
  upperBounds <- c(Ka = 10^10,
    c(I0 = 10^2, IHD = 10^10, ID = 10^4), # 470
    c(I0 = 10^2, IHD = 10^10, ID = 10^4), # 486
    c(I0 = 10^2, IHD = 10^10, ID = 10^4), # 512
    c(I0 = 10^2, IHD = 10^10, ID = 10^4), # 524
    c(I0 = 10^2, IHD = 10^10, ID = 10^4), # 532
    c(I0 = 10^2, IHD = 10^10, ID = 10^4)  # 550
  )
