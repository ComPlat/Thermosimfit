gdaUI <- function(id) {
  tabItem(
    ...
    tags$script(
      "Shiny.addCustomMessageHandler('GDAupdateFieldVapro', function(message) {
              var result = message.message;
              $('#GDA-output_vapro').html(result);
            });"
    ),
    tags$script(
        ...
        tabPanel(
          ...
          fluidRow(
            box(
              ...
              textInput(NS(id, "G0_vapro"), "Guest conc. [M]", value = "0"),
        ...
        tabPanel(
          ...
          fluidRow(
            box(
              ...
              textInput(NS(id, "G0_batch"), "Guest conc. [M]", value = "0"),
        ...
        tabPanel(
          ...
          fluidRow(
            box(
              ...
              textInput(NS(id, "G0_vapro_batch"), "Guest conc. [M]", value = "0"),
