hgUI <- function(id) {
  tabItem(
    ...
    tags$script(
      "Shiny.addCustomMessageHandler('HGupdateFieldVapro', function(message) {
              var result = message.message;
              $('#HG-output_vapro').html(result);
            });"
    ),
    tags$script(
    ...
    tags$script(
      "Shiny.addCustomMessageHandler('HGupdateFieldVaproBatch', function(message) {
              var result = message.message;
              $('#HG-output_Vapro_Batch').html(result);
            });"
    ),
    tags$script(
      "Shiny.addCustomMessageHandler('HGupdateFieldUncertainty', function(message) {
              var result = message.message;
              $('#HG-output_uncertainty').html(result);
            });"
    ),
    tags$script(
      "Shiny.addCustomMessageHandler('HGupdateFieldVaproUncertainty', function(message) {
              var result = message.message;
              $('#HG-output_vapro_uncertainty').html(result);
            });"
    ),
    fluidRow(
      tabBox(
