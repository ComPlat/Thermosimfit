    ...
    fluidRow(
      ...
      box(
        ...
        box(
          ...
          textInput(NS(id, "GDA_I0_ub"), "I(0) value upper boundary", value = 1)
        ),
        box(
          textInput(NS(id, "GDA_IHD_lb"), "I(HD) value lower boundary [1/M]", value = 0),
          textInput(NS(id, "GDA_IHD_ub"), "I(HD) value upper boundary [1/M]", value = 1e06)
        ),
        box(
          textInput(NS(id, "GDA_ID_lb"), "I(D) value lower boundary [1/M]", value = 0),
          textInput(NS(id, "GDA_ID_ub"), "I(D) value upper boundary [1/M]", value = 1e06)
        ),
