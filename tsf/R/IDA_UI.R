idaUI <- function(id) {
  ...
  tabItem(
    ...
    tags$script(
      "Shiny.addCustomMessageHandler('IDAupdateFieldVapro', function(message) {
      var result = message.message;
      $('#IDA-output_vapro').html(result);
      });"
    ),
    tags$script(
    ...
    tags$script(
      "Shiny.addCustomMessageHandler('IDAupdateFieldVaproBatch', function(message) {
      var result = message.message;
      $('#IDA-output_Vapro_Batch').html(result);
      });"
    ),
    tags$script(
      "Shiny.addCustomMessageHandler('IDAupdateFieldUncertainty', function(message) {
      var result = message.message;
      $('#IDA-output_uncertainty').html(result);
      });"
    ),
    tags$script(
      "Shiny.addCustomMessageHandler('IDAupdateFieldVaproUncertainty', function(message) {
      var result = message.message;
      $('#IDA-output_vapro_uncertainty').html(result);
      });"
    ),
    fluidRow(
      tabBox(
        ...
        tabPanel(
          ...
          fluidRow(
            box(
              textInput(NS(id, "H0_vapro"), "Host conc. [M]", value = 0),
              textInput(NS(id, "D0_vapro"), "Dye conc. [M]", value = "0"),
              textInput(NS(id, "kHD_vapro"), HTML("K<sub>a</sub>(HD) [1/M]"), value = "0"),
              box(
                title = "Advanced options",
                collapsible = TRUE, collapsed = TRUE,
            ...
            box(
              textInput(NS(id, "kHG_lb_vapro"), HTML("K<sub>a</sub>(HG) value lower boundary [1/M]"), value = 10),
              textInput(NS(id, "kHG_ub_vapro"), HTML("K<sub>a</sub>(HG) value upper boundary [1/M]"), value = 1e08),
              width = 6,
              title = "Boundaries",
              solidHeader = TRUE,
              status = "warning", height = 700
          ...
          fluidRow(
            box(
              ...
              width = 14, title = "VAPRO Optimization", solidHeader = TRUE,
              collapsible = TRUE, status = "warning"
            )
          )
        ),
        ...
        tabPanel(
          ...
          fluidRow(
            box(
              textInput(NS(id, "H0_batch"), "Host conc. [M]", value = 0),
              textInput(NS(id, "D0_batch"), "Dye conc. [M]", value = "0"),
              textInput(NS(id, "kHD_batch"), HTML("K<sub>a</sub>(HD) [1/M]"), value = "0"),
              box(
                title = "Advanced options",
                collapsible = TRUE, collapsed = TRUE,
                box(
        ...
        tabPanel(
          ...
          fluidRow(
            box(
              textInput(NS(id, "H0_vapro_batch"), "Host conc. [M]", value = 0),
              textInput(NS(id, "D0_vapro_batch"), "Dye conc. [M]", value = "0"),
              textInput(NS(id, "kHD_vapro_batch"), HTML("K<sub>a</sub>(HD) [1/M]"), value = "0"),
              box(
                title = "Advanced options",
                collapsible = TRUE, collapsed = TRUE,
            ...
            box(
              textInput(NS(id, "kHG_lb_vapro_batch"), HTML("K<sub>a</sub>(HG) value lower boundary [1/M]"), value = 10),
              textInput(NS(id, "kHG_ub_vapro_batch"), HTML("K<sub>a</sub>(HG) value upper boundary [1/M]"), value = 1e08),
              width = 6,
              title = "Boundaries",
              solidHeader = TRUE,
              status = "warning", height = 700
        ...
        tabPanel(
          ...
          fluidRow(
            box(
              ...
              conditionalPanel(
                condition = paste0("input['", ns("uncertainty_method"), "'] == 'batch'"),
              ...
              conditionalPanel(
                condition = paste0("input['", ns("uncertainty_method"), "'] == 'direct'"),
